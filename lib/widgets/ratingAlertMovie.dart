...
class RatingDialogMovie extends StatefulWidget {
  final num? movieId;
  ...
  @override
  _RatingDialogMovieState createState() => _RatingDialogMovieState();
}

class _RatingDialogMovieState extends State<RatingDialogMovie> {
  double _rating = 0.0;
